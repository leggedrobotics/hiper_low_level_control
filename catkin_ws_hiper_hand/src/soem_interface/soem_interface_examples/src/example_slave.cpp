...
// #include <soem_rsl/ethercatmain.h>
 #include <soem_rsl/ethercattype.h>
//#include <soem_rsl/ethercatcoe.h>
...
int main(int argc, char** argv) {
  const std::string busName = "enp0s31f6"; //origianl eth1
  const std::string slaveName = "MCPA_drive"; // original ExampleSlave
  const uint32_t slaveAddress = 1; //original 0
